...
// อาชีพแนะนำตามแต่ละด้าน (8 อาชีพต่อด้าน)
const RIASEC_CAREERS = {
    realistic: ['วิศวกร', 'ช่างเทคนิค', 'เกษตรกร', 'สถาปนิก', 'ช่างก่อสร้าง', 'นักบิน', 'ช่างยนต์', 'ช่างไฟฟ้า'],
    investigative: ['นักวิทยาศาสตร์', 'นักวิจัย', 'แพทย์', 'ทันตแพทย์', 'เภสัชกร', 'นักวิเคราะห์ระบบ', 'นักสถิติ', 'นักชีววิทยา'],
    artistic: ['นักออกแบบกราฟิก', 'ศิลปิน', 'นักดนตรี', 'นักเขียน', 'นักแสดง', 'สถาปนิก', 'นักออกแบบแฟชั่น', 'ช่างภาพ'],
    social: ['ครู', 'นักสังคมสงเคราะห์', 'พยาบาล', 'นักจิตวิทยา', 'ที่ปรึกษา', 'นักกิจกรรมบำบัด', 'นักพัฒนาชุมชน', 'เจ้าหน้าที่สาธารณสุข'],
    enterprising: ['ผู้ประกอบการ', 'ผู้บริหาร', 'นักการตลาด', 'ผู้จัดการ', 'พนักงานขาย', 'นักประชาสัมพันธ์', 'นายหน้าอสังหาริมทรัพย์', 'ที่ปรึกษาทางธุรกิจ'],
    conventional: ['นักบัญชี', 'ผู้ตรวจสอบบัญชี', 'พนักงานธุรการ', 'เสมียน', 'นักวิเคราะห์การเงิน', 'ผู้จัดการสำนักงาน', 'นักวางแผน', 'ผู้ควบคุมคลังสินค้า']
};
