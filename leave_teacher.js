...
function exportExcel() {
    ...
    ws['!cols'] = [{wch:15}, {wch:12}, {wch:12}, {wch:20}, {wch:15}, {wch:15}, {wch:12}, {wch:12}, {wch:35}, {wch:15}, {wch:30}];
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, "ประวัติการลา");
    XLSX.writeFile(wb, `ประวัติการลา_${currentProfile.first_name}.xlsx`);
}

// 🌟 6. ฟังก์ชันพิมพ์ใบลา PDF (สำหรับครู)
function printLeavePDF(id) {
    Swal.fire({
        icon: 'info',
        title: 'ระบบพิมพ์ใบลา',
        text: 'กำลังอยู่ในขั้นตอนพัฒนาฟังก์ชันสร้างไฟล์ PDF ครับ (คุณครูจะสามารถกดพิมพ์ใบลาออกมาส่งได้เลยในอนาคต)',
